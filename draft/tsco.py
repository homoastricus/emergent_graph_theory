...
class ScientificEmergentSpacetime:
    ...
    def __init__(self, N: int = 800, K: int = 6, p: float = 0.05,
    ...
    def _initialize_network(self) -> None:
        ...
        self.G = nx.watts_strogatz_graph(self.N, self.K, self.p, seed=42)
...
if __name__ == "__main__":
    ...
    simulator = ScientificEmergentSpacetime(
        N=8000,  # Оптимальный размер для точности и скорости
        K=8,  # Для 3D геометрии
        p=0.055,  # Режим малого мира 2.678 2.753(084) 2.706(088)
        time_steps=100,
